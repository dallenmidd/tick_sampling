# tick_sampling
Code and data for the paper: B. Borgmann-Winter and D. Allen. 2019. How the distance between drag-cloth checks affects the estimate of adult and nymphal _Ixodes scapularis_ (Acari: Ixodidae) density. _Journal of Medical Entomology. In press._
